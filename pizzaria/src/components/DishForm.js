...
function DishForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const newDish = { dishName, description, price };
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('Failed to submit the dish data, try again later');
            }
            ...
            console.error('An error occurred while submitting the dish data:', error);
